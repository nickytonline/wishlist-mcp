  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {granted ? '🌟✨ WISH GRANTED! ✨🌟' : "✨ WINTER FAIRY'S WISHBOX ✨"}
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-4 pt-6">
        ...
        <div className="pl-11 space-y-2 text-base" style={{ color: '#0f3460' }}>
          <p className="font-medium">
            Category:{' '}
            <span className="text-winter-ice-blue capitalize">{category}</span>
          </p>
          <p className="font-medium">
            Priority:{' '}
